<a href="hasil_tokenisasi.php"> LIHAT TABEL </a> <a href="index1.php" style="background-color:yellow">Home</a>
 <?php
...
$lokasi_file = $_FILES['fdokumen']['tmp_name'];
$nama_file   = $_FILES['fdokumen']['name'];
